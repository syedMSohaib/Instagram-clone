This is a [Next.js](https://nextjs.org/) learning project aims to create Instagram clone bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
